...
\ques{
	Given an array of numbers, $nums$, return an array of numbers $products$, where $products[i]$ is the product of all $nums[j], j != i$. Give an $O(N)$ algorithm using only multiplication.
}
