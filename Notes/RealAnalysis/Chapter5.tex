...
\coro{
	If $f$ is differentiable on $[a,b]$, then $f'$ cannot have any simple discontinuities on $[a,b]$. \smallmarginpar{Compare with Corollary~\ref{coro: monotone functions do not have discontinuities of the second kind.}}
}\label{coro: derivative functions do not have discontinuities of the first kind.}
